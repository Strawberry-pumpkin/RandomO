...
def home():
    ...
    if "username" in session:
        if exists(f'static/profile-pics/{session.get("username")}.jpg'):
            profile_picture = session.get("username") + ".jpg"

        elif exists(f'static/profile-pics/{session.get("username")}.png'):
            profile_picture = session.get("username") + ".png"

        elif exists(
                f'static/profile-pics/{session.get("username")}.jpeg'
        ):
